...
public static class GerstnerWavesJobs {
  ...
  // Permet d'initialiser même si Play Mode Options est coché
  [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
  public static void Init(){

    // Empêche d'initialiser 2x si Enter Play Mode Options n'est pas coché
    try
    {
      bool b =  Water.Instance._waves.Length == 0;
    }
    catch
    {
      return;
